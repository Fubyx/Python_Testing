#ball mit houghCircles suchen und SobelGradientfilter
...
def mark_ball_in_color(frame, lower_color, upper_color,min_radius, color_tolerance):
    ...
    circles = cv2.HoughCircles(combined, cv2.HOUGH_GRADIENT, 1, 50, param1=90, param2=30, minRadius=10, maxRadius=300)
